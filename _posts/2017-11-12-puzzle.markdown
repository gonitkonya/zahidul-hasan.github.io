...
<embed src="/assets/pdfs/puzzle.pdf" width="600px" height="900px" />
...
<center>$\frac{1}{n}, \frac{2}{n}, \cdots, \frac{n}{n}$ </center>     
Now, let's express them in their reduced forms. If there is a fraction such as, $\frac{a}{d}$, then definitely $a \leq d$ and $\gcd(a,d) = 1$. Because, otherwise, it wouldn't be an irreducible fraction. And there will be exactly $\varphi(d)$ such $a$ for each $d$. And the fractions that will have $d$ as their denominator are disjoint from all other fractions and there are $n$ fractions in total. QED.
