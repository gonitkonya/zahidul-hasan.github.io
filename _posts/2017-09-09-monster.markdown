...
<ol>
  ...
  <li><strong>Official Pseudocode:</strong>
    <ul>
   <li><img src="/assets/img/nex.jpg" alt="pseudocode" width="60%" height="60%"></li>
      ...
      <li> <p> Yet, another variant is called $LP_{mix}(\alpha)$:</p>
        <img src="/assets/img/lpmix.jpg" alt="lp subroutine" width="60%" height="60%">
      </li>
    </ul>
  </li>
...
<ol>
  ...
  <li>
    ...
    <ul>
      ...
      <li> Makes only $\sart{\frac{KT}{\log{\mathcal{O}}}}$ calls to the oracle which is phenomenal compared to it's precursor Randomized UCB </li>
    </ul>
  </li>
  <li><strong>Official Pseudocode:</strong>
    <ul>
   <li><img src="/assets/img/conbandit.jpg" alt="pseudocode" width="60%" height="60%"></li>
    </ul>
  </li>
  <li><strong>Regret Bounds:</strong>
    <ul>
  ...
  <li>
    <strong>Drawbacks and Scope of Work:</strong>:
    <ul>
      <li>Time complexity is $\sart{\frac{K^{3}T^{3}}{\log{\mathcal{O}}}}$. Can be optimized.</li>
