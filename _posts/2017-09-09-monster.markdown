...
<ol>
  ...
  <li>
    ...
    <ul>
      ...
      <li> Uses the fact that when $K$ is significantly large and even larger than $M$, then the regret upper bound need not be $\sqrt{TK \log{M}}$.
    </ul>
  </li>
  <li><strong>Official Pseudocode:</strong>
    <ul>
   <li><iframe src="https://drive.google.com/file/d/1D_E_NI61Nf3wazulFlMAxFChdAJi2cHR/preview" width="640" height="480" allow="autoplay"></iframe></li>
      ...
      <li> <p> Yet, another variant is called $LP_{mix}(\alpha)$:</p>
        <iframe src="https://drive.google.com/file/d/1bAFLfdoX1zT5qoFCUujUKh7tX5ecKBoX/preview" width="640" height="480" allow="autoplay"></iframe>
      </li>
    </ul>
  </li>
